...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#1f17b9] to-[#380B60] text-white/70">
        <img src="/logo4.png" alt="logo" className="h-11 w-auto" />
        <p className="mt-4 text-center">
          Copyright © 2026 <a href="https://prebuiltui.com">Resume Builder</a>.
